  ...
  return (
    <>
      ...
      <aside style={{
        ...
        width: isMobile ? "100%" : 440, maxWidth: isMobile ? "100vw" : "92vw",
        ...
        <div style={{ padding: isMobile ? "18px 20px" : "24px 28px", display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "1px solid rgba(74,46,28,.15)" }}>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: isMobile ? "8px 20px" : "8px 28px" }}>
          {items.length === 0 ? (
            ...
            <div key={it.key} style={{ display: "grid", gridTemplateColumns: `${imgSize}px 1fr auto`, gap: isMobile ? 12 : 16, padding: "20px 0", borderBottom: "1px solid rgba(74,46,28,.1)" }}>
              <div style={{ width: imgSize, height: imgSize, background: it.swatch, backgroundImage: `url(${it.img})`, backgroundSize: "contain", backgroundPosition: "center", backgroundRepeat: "no-repeat" }} />
              <div>
        ...
        {items.length > 0 && (
          <div style={{ padding: isMobile ? "16px 20px 24px" : "20px 28px 28px", borderTop: "1px solid rgba(74,46,28,.15)" }}>
