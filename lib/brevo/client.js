 ...
 *
 * @param {Object}  opts
 * @param {string|{email:string,name?:string}} opts.to  Destinatario.
...
export async function sendTransactionalEmail({
  ...
  // Normalizamos el destinatario al formato que espera Brevo: array de objetos.
  const recipient =
    typeof to === "string" ? { email: to } : { email: to.email, name: to.name };
